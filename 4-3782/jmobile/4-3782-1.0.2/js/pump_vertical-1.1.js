...
this.wgtPumpLeftPressValue = wgt.getWidget(wgt.id + ".pressure_sensor_down.numeric1")
this.wgtPumpRightPressValue = wgt.getWidget(wgt.id + ".pressure_sensor_up.numeric1")
this.wgtPumpLeftWarn = wgt.getWidget(wgt.id + ".pressure_sensor_down.warn_sign")
this.wgtPumpRightWarn = wgt.getWidget(wgt.id + ".pressure_sensor_up.warn_sign")
...
if (_direction == "down"){
    this.wgtPumpSymbol.setProperty("rot", 90)
}else{
    this.wgtPumpSymbol.setProperty("rot", -90)
}
...
this.button_onMouseClick = function(me,eventInfo)
{
    ...
    project.setTag("pump_dialog_y", this.wgtPump.getProperty("y"));
