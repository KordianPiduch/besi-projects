...
this.BtnIllum1_ind1_onDataUpdate = function(me,eventInfo)
{
    ...
    var _in_control = project.getTag("OPCUAServer@BESI-1|Objects|DeviceSet|WAGO 750-8212 PFC200 G2 2ETH RS|Resources|Application|Programs|control|system_control|system_control["+_system_id.toString()+"]|system_control["+_system_id.toString()+"]["+hmi_id.toString()+"]|in_control")
    if (_in_control == true){
